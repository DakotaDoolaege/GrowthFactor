 ...
 * 
 * Modified by Dakota Doolaege 2019-10-2
 */
...
namespace TouchScript.Behaviors
{
    ...
    public class Transformer : MonoBehaviour
    {
        // Here's how it works.
        //
        // If smoothing is not enabled, the component just gets gesture events
        // in stateChangedHandler(), passes Changed event to manualUpdate() which 
        // calls applyValues() to set updated values.
        // The value of transformMask is used to only set values which were changed
        // not to interfere with scripts changing this values.
        //
        // If smoothing is enabled — targetPosition, targetScale, targetRotation are
        // cached and a lerp from current position to these target positions is applied
        // every frame in update() method. It also checks transformMask to change only needed
        // values.
        // If none of the delta values pass the threshold, the component transitions to idle
        // state.
        ...
        private void applyValues()
        {
            ...
            //instead of calling the transform, send target position to drag and drop script?
            moveObject();
            transformMask = TransformGesture.TransformType.None;
        }
        ...
        /// <summary>
        /// Modification to framework by Dakota.
        /// This function will move the object by applying force which provides smooth movement and conservation of momentum on release.
        /// </summary>
        /// <value>
        /// <c>true</c> if this transform can be changed from another script; otherwise, <c>false</c>.
        /// </value>
